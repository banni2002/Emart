            ...
            <div className="card bg-dark text-black boder-0">
                ...
                <div className="card-img-overlay d-flex flex-column justify-content-center">
                    <div className="container bg-white col-md-4">
                        <form className="">
                            <h3 className='text-center text-uppercase h3 py-2'>Đăng ký</h3>
                            
                            <div className="form-group py-2">
                                <label htmlFor="exampleInputEmail1">Tên đăng nhập</label>
                                <input type="username" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên đăng nhập" />
                            </div>
                            <div className="form-group py-2">
                            ...
                            <button type="submit" className="btn btn-outline-primary mb-2 w-100">Đăng ký</button>
                            <div className="btn-group">
                            <button className='btn btn-outline-primary w-100 mb-2'><i className="fa fa-google me-2"></i>Đăng ký bằng Google</button>
                            <button className='btn btn-outline-primary w-100 mb-2'><i className="fa fa-facebook me-2"></i>Đăng ký bằng Facebook</button>
                            </div>
                            <div className="form-group text-black mb-2 py-2">
                            <NavLink to="/register" className="mb-2"> Bạn đã có tài khoản? Đăng nhập </NavLink>
                            </div>
                        </form>
                    </div>
                </div>
